        ...
        <div class="w-10/12 lg:w-1/3 md:w-1/2 sm:w-3/4 mx-auto sm:px-6 lg:px-8 px-3 bg-white shadow py-6">
            <form action="/authors" method="post" enctype="multipart/form-data">
                ...
                <div class="mx-auto">
                    ...
                    <input id="name" name="name" required class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                </div>
                <div class="mt-6 mx-auto">
                    ...
                    <div class="rounded-md shadow-sm">
                        <textarea id="about" name="information" rows="5" class="form-textarea mt-1 block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" placeholder="Информация об авторе"></textarea>
                    </div>
                </div>
                <div class="mt-6 mx-auto">
                    <label for="country" class="block text-sm font-medium leading-5 text-gray-700">Страна</label>
                    <input id="country" name="country" required class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" placeholder="Например, ENG">
                </div>
                <div class="mt-6 mx-auto">
