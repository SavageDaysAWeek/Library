        ...
        <div class="w-10/12 lg:w-1/3 md:w-1/2 sm:w-3/4 mx-auto sm:px-6 lg:px-8 px-3 bg-white shadow py-6">
            <form action="/books" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-6 mx-auto">
                    ...
                    <input id="published_at" type="number" min="1500" max="2100" name="published_at" required class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                </div>
                <div class="mt-6 mx-auto">
